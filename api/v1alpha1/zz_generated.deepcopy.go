...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FluxVersion) DeepCopyInto(out *FluxVersion) {
	*out = *in
	if in.ChartURL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FluxVersion.
func (in *FluxVersion) DeepCopy() *FluxVersion {
	if in == nil {
		return nil
	}
	out := new(FluxVersion)
