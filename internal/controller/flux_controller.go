...
func (r *FluxReconciler) CreateOrUpdate(ctx context.Context, svcobj *apiv1alpha1.Flux, _ *apiv1alpha1.ProviderConfig, clusters spruntime.ClusterContext) (ctrl.Result, error) {
	// TODO
